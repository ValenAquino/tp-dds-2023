...
public class Usuario {
  ...
  public void notificarAperturaDeIncidente(Incidente incidente) {
    if (puedeRecibirNotificacion()) {
      medioDeComunicacion.notificarAperturaDeIncidente(incidente, getCorreoElectronico());
    }
  ...
  public void sugerirRevisionDeIncidente(Incidente incidente) {
    if (puedeRecibirNotificacion()) {
      medioDeComunicacion.sugerirRevisionDeIncidente(incidente, getCorreoElectronico());
    }
  }
